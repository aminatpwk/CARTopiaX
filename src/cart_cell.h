...
class CarTCell : public Cell, public ISubstanceInteractor {
 ...
 public:
  ...
  CarTCell& operator=(const CarTCell&) = delete;
  CarTCell& operator=(CarTCell&&) = delete;
  ...
  real_t ConsumeSecreteSubstance(int substance_id, real_t old_concentration) override;
